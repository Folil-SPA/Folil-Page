  ...
  return (
    <section id="team">
            ...
            <ScrollReveal key={m.name} type={i===0?"slide-left":"slide-right"} delay={200}>
              <div className="team-card">
                <div className="team-card-top">
                  <div className="avatar-ring"><img className="avatar" src={m.image} alt={m.name} /></div>
      ...
      <style jsx>{`
        ...
        .avatar-ring { width: 72px; height: 72px; flex-shrink: 0; border-radius: 50%; background: linear-gradient(135deg, var(--accent), var(--accent2)); padding: 2px; }
